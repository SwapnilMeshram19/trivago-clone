...
function Footer(){  
    return(
       ...
       <p style = {{marginLeft:240,marginBottom:-10,fontSize:13}}>trivago N.V., KesselstraBe 5-7,40221Dusseldorf</p>
       <a href = "#" style={{marginLeft:-15,marginLeft:240}}>germany</a>
       {/* <span> */}
    ...
    <div className='footer'>
      ...
      <div><h1 style = {{textAlign:'center'}}>trivago</h1>
      <p style = {{fontSize:12,marginTop:-10,textAlign:'center'}}>Copyright 2022 trivago | All right reserved</p>
        </div>
        </div>
        </>
    )
