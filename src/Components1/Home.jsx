...
//   {filteredArray ?  : data}
  ...
  // console.log(AllStays)
    ...
    // useEffect(()=>{
    //   getCity(dispatch)
    //   setCarousalData(city)
    //   console.log(city)
    // },[])
    const [carousalData, setCarousalData]=useState(city)
    ...
    return (
        ...
        { calendarStatus ?  (
            ...
            <div className="below_Navbar_logo_container">
                ...
                <div>
                    <div><h3 style={{  fontFamily: 'Proxima Vara,Arial,Helvetica,Sans,Sans-Serif'}}>Deals from your favorite booking sites</h3></div>
                    <div><p style={{  fontFamily: 'Proxima Vara,Arial,Helvetica,Sans,Sans-Serif'}}>Try searching for a city, a specific hotel, or even a landmark!</p></div>
                </div>
            </div>
            <div className="serching_Box">
                        ...
                        <div onClick={()=>setCalendarStatus(!calendarStatus)} >
                            <div >
                                ...
                                <div className='check_in_out'>
                                    <p>Check in</p>
                                    <b>{showingDay1},{day1.getDate()}-{day1.getMonth()+1}-{day1.getFullYear()}</b>
                                </div>
                                <div className='check_in_out'>
                                    <p>Check Out</p>
                                    <b>{showingDay2},{day2.getDate()}-{day2.getMonth()+1}-{day2.getFullYear()}</b>
                ...
                <div className='compareLine'><h5>We compare multiple booking sites at once</h5></div>
